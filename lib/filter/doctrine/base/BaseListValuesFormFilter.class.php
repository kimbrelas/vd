...
/**
 * ListValues filter form base class.
 *
 * @package    dukaan
 * @subpackage filter
 ...
 */
abstract class BaseListValuesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('list_values_filters[%s]');
